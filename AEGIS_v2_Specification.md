# Project AEGIS v2: Adversarial Enterprise Guard for Intrinsic Security
...
AEGIS is a research project to build an open, living dataset and reproducible training pipeline that improves open models' resistance to prompt-based, multi-turn, and indirect/RAG/tool attacks while minimizing over-refusal.
...
```json
{
  ...
  "activation_capture": {
    ...
    "capture_path": "activations/aegis-mt-00421.safetensors",
...
| AEGIS Benign | False positive detection | Internal |
...
*This document serves as the authoritative specification for Project AEGIS v2. All implementation work should reference this specification.*
