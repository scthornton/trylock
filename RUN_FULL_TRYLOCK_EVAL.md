# How to Run Full TRYLOCK Evaluation (Layer 1+2+3)

This guide shows you how to run the complete TRYLOCK evaluation to get the final ASR and ORR numbers for Table 2 in the paper.
...
1. **Loads all three TRYLOCK layers:**
...
```
======================================================================
FULL TRYLOCK EVALUATION REPORT (Layer 1 + 2 + 3)
======================================================================
...
Full TRYLOCK (adaptive α)  |  9.2%  |  46.0%  |  Adaptive
...
```markdown
| Full TRYLOCK (adaptive α) | 9.2% | 46.0% | ~82% (relative to baseline) |
```
...
The full TRYLOCK system loads 3 models. Try:
...
```bash
ls ./outputs/trylock-sidecar/adapter_config.json
```
...
2. **Add the row to Table 2** in `paper/TRYLOCK_Canonical.md`
